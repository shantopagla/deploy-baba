...
### `EnvironmentInterpolator` unused [OPEN — W-XT.4.2]

Dead code warning: `EnvironmentInterpolator` struct exists in xtask but is not called
from any justfile recipe or module path. Either wire it up or remove it.
...
- [ ] **W-XT.4.2** — Remove or wire up `EnvironmentInterpolator`
